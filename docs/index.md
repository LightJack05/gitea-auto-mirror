...
!!! info "Info"
    Gitea Auto Mirror only works with HTTP-based mirror servers, as others are [not supported by Gitea](https://docs.gitea.com/usage/repo-mirror#mirror-an-existing-ssh-repository).
